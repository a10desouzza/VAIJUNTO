...
/* ValidarEmail
 *
 * Recebe: email: endereco de e-mail em texto.
 *
 * O que faz: confere o formato e o dominio. Nao verifica se a caixa de e-mail realmente existe.
 *
...
/* ValidarNome
 *
 * Recebe: nome: nome informado no cadastro.
 *
 * O que faz: confere tamanho, letras e separadores aceitos no nome.
 *
 * Retorna: nil para nome aceito; error se tamanho, caracteres ou quantidade de letras forem
 * invalidos.
 */
...
/* ValidarSenha
 *
 * Recebe: senha: texto informado para a conta.
 *
 * O que faz: confere tamanho e caracteres de controle. Retorna nil quando o formato e aceito.
 *
...
/* ValidarCidade
 *
 * Recebe: cidade: nome de uma origem, destino ou parada.
 *
 * O que faz: aceita acentos e numeros, mas exige ao menos uma letra e limita o tamanho.
 *
